...
@.Codex/rules/code-quality.md @.Codex/rules/commit-discipline.md @.Codex/rules/spec-conventions.md
...
├── .Codex/             ← agents, sdd-* commands, hooks, rules, skills, templates
...
| "How do I write a user story?" | `.Codex/skills/writing-user-stories/SKILL.md` |
| "Should this rule be a hook, command, or prose?" | `.Codex/rules/enforcement-hierarchy.md` |
