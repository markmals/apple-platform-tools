...
Each green-refactor cycle is a natural commit boundary. Once the suite is green and the refactor is clean, commit before starting the next red. See `.Codex/rules/commit-discipline.md`.
